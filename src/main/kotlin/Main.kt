fun main() {
    println("Это приложение, в котором пользователь вводит две различных цифры. На выходе приложение выдает, если это возможно, из введенных цифр, нечетное число. Результат, естественно, выводится.\nПри невозможности создать нечетное число выводится сообщение – случится страшное... Каждое число вводится на отдельной строке :)\n")
    while (true) {
